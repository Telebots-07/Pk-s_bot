...
async def tutorial(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("⚠️ Error starting tutorial. Try again.")
        log_error(f"Tutorial error: {str(e)}, user_id: {user_id}")
...
async def show_tutorial_step(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("⚠️ Error showing tutorial step. Try again.")
        log_error(f"Show tutorial step error: {str(e)}")
...
async def handle_tutorial_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await query.message.reply_text("⚠️ Error in tutorial navigation. Try again.")
        log_error(f"Tutorial callback error: {str(e)}")
